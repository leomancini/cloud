        ...
        <PostItem data-post-id={post.id}>
          ...
          <div {...postReactProps}>
            ...
            {post.place_name && post.place_lat && (
              <PostLocation as="a" href={post.place_maps_url || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(post.place_name + (post.place_address ? ", " + post.place_address : ""))}`} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit", cursor: "pointer" }}>
                <PostMapWrapper>
