...
const CLASSIFY_TOOLS = [
  {
    ...
    input_schema: {
      type: "object",
      properties: {
        comment: { type: "string", description: SOL_EMOJI_ONLY ? "The comment to post. Must be ONLY emoji characters — no letters, no words, no punctuation. Use 1-20 emoji. Match the length to the message: a simple greeting or yes/no might be just 1-2 emoji, a detailed reaction could be 10-20. Be proportional." : "The comment to post. All lowercase, 1-2 sentences, no emojis. Casual and genuine, not performative." }
      },
      required: ["comment"]
    }
  },
...
- post_comment: ${SOL_EMOJI_ONLY ? "Respond using ONLY emoji — no words, no letters, no punctuation. Use 1-20 emoji, matching the length to the situation: 1-2 for a quick reaction, 5-10 for a normal response, up to 20 for something that deserves a big expressive reply. Be proportional to what was said." : "Write a short, casual comment like a real person would. 1-2 sentences. No emojis. All lowercase. Don't be overly enthusiastic or try to be clever \u2014 just be genuine and low-key."} Use this for casual messages, greetings, questions, or anything that isn't explicitly asking for a code change or a game.
